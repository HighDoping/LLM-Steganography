from llm_steganography import llm_steganography
...
def test_decode():
    ...
    plaintext = "Secret"
    decoded = llm_steganography.llm_decode(
        encoded, password=None, base=16, char_per_index=8
    )
...
def test_aes_decode():
    ...
    password = "password"
    decoded = llm_steganography.llm_decode(
        encoded, password=password, base=16, char_per_index=8
    )
    assert decoded == plaintext
